...
var itemsToRemoveAndHide = [
    ...
    <item:minecraft:netherite_helmet>, <item:minecraft:netherite_chestplate>, <item:minecraft:netherite_leggings>, <item:minecraft:netherite_boots>, <item:minecraft:flint_and_steel>, <item:minecraft:shears>, <item:minecraft:shield>, <item:minecraft:bow>, <item:minecraft:crossbow>,
    ...
    <item:autumnity:snail_shell_chestplate>,
...
<item:minecraft:shield>, <item:minecraft:bow>, <item:minecraft:crossbow>, <item:minecraft:shears>,
